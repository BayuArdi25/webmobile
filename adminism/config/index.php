...
// Fungsi untuk mendapatkan jumlah total data dari tabel tertentu
...
// Mendapatkan jumlah total dari setiap tabel
$totalProduk = getTotalCount($conn, 'produk');
$totalLayanan = getTotalCount($conn, 'layanan');
$totalSiteExp = getTotalCount($conn, 'siteexp');
$totalProjectExperience = getTotalCount($conn, 'project_experience');
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Site Experience
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $totalSiteExp ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Project Experience
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $totalProjectExperience ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
