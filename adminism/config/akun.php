...
// Query untuk mengambil data produk berdasarkan email
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Edit Data Users</h1>
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form enctype="multipart/form-data" method="POST" action="logika_proses/logika.php">
            ...
            <button type="submit" name="updatedatauser" class="btn btn-primary mt-3">Edit</button>
        </form>
    </div>
</div>
