...
$query = "SELECT * FROM siteexp WHERE no = ?";
    ...
    <div class="card-body">
        <form enctype="multipart/form-data" method="POST" action="../logika_proses/logika.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="siteCategory" id="siteCategory" placeholder=""
                    value="<?php echo htmlspecialchars($data['category'], ENT_QUOTES); ?>">
            </div>
            <div class="form-group">
                <label for="siteCount">Count</label>
                <input type="text" class="form-control" name="siteCount" id="siteCount" placeholder=""
                    value="<?php echo htmlspecialchars($data['count'], ENT_QUOTES); ?>">
            </div>
            <button type="submit" name="updatedatasite" class="btn btn-primary mt-3">Edit</button>
        </form>
    </div>
</div>
