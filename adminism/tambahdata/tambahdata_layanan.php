                    ...
                    <div class="card-body">
                            <form enctype="multipart/form-data" method="POST" action="../logika_proses/logika.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="layananDescription" id="layananDescription" rows="3" placeholder="Masukkan Deskripsi Layanan"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="layananImage">Gambar</label>
                                    <input type="file" name="layananImage" class="form-control-file" id="layananImage">
                                </div>
                                <button type="submit" name="tambahdatalayanan" class="btn btn-primary mt-3">Simpan</button>
                            </form>
                        </div>
                    </div>
