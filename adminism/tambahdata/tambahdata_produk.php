                    ...
                    <div class="card-body">
                            <form enctype="multipart/form-data" method="POST" action="../logika_proses/logika.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="productDescription" id="productDescription" rows="3" placeholder="Masukkan Deskripsi Produk"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="productImage">Gambar</label>
                                    <input type="file" name="productImage" class="form-control-file" id="productImage">
                                </div>
                                <button type="submit" name="tambahdataproduk" class="btn btn-primary mt-3">Simpan</button>
                            </form>
                        </div>
                    </div>
