                    ...
                    <div class="card-body">
                            <form enctype="multipart/form-data" method="POST" action="../logika_proses/logika.php">
                                <div class="form-group">
                                    <label for="siteCategory">Nama category</label>
                                    <input type="text" class="form-control" name="siteCategory" id="siteCategory" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="siteCount">count</label>
                                    <input type="number" class="form-control" name="siteCount" id="siteCount" placeholder="">
                                </div>
                                <button type="submit" name="tambahdatasite" class="btn btn-primary mt-3">Simpan</button>
                            </form>
                        </div>
                    </div>
